# -*- coding: utf-8 -*-
"""
Created on Sun Dec  5 11:29:49 2021
...
input_images_path = "imagenes de muestra"
files_name = os.listdir(input_images_path)

output_images_path = "imagenes resultantes"
...
for file_name in files_name:
    ...
    image = (input_images_path + "\\" + file_name)
    
    if image is None:
        continue
    
    frame = detection(image)
    cv2.imwrite(output_images_path + "\\" + file_name, frame)
    #print(image)